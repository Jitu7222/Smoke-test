...
public class Scapia {
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            driver.get("https://app.perceptinsight.com/perceptpixel/home");
            ...
            WebElement pathElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div/main/div[2]/div[2]/div/div/div/div[2]/div/div/div/div/button/svg")));
            pathElement.click();
            ...
            WebElement addEventButton = driver.findElement(By.xpath("//button[normalize-space()='Add Event']"));
            addEventButton.click();

            WebElement allEventsElement = driver.findElement(By.xpath("//p[normalize-space()='LANDING PAGE OPEN']"));
            allEventsElement.click();

            WebElement EventButton = driver.findElement(By.xpath("//button[normalize-space()='Add Event']"));
            EventButton.click();
            WebElement fileUploadedElement = driver.findElement(By.xpath("//p[normalize-space()='FILE UPLOADED']"));
            fileUploadedElement.click();

            Thread.sleep(10000);
            WebElement targetElement = driver.findElement(By.xpath("/html[1]/body[1]/div[1]/main[1]/div[2]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]"));
            targetElement.click();
            ...
            WebElement liElement = driver.findElement(By.xpath("//html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[2]/button[4]/div[1]/*[name()='svg']"));
            liElement.click();
