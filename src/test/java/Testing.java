...
public class Testing {
    ...
    public void setUp() {
        ...
        // Create ChromeOptions and configure for secure site handling and headless mode
        ...
        options.addArguments("--disable-gpu");  // Disables GPU hardware acceleration, useful in headless mode
        options.addArguments("--window-size=1920x1080");  // Set a window size to avoid issues with certain websites
    ...
    public void testNavigateToLoginPage() throws InterruptedException {
        ...
        WebElement signInWithMicrosoft = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Sign in with Google']")));
        Assert.assertTrue(signInWithMicrosoft.isDisplayed(), "Sign in with Google button is not visible.");
    ...
    public void testEmailInput() throws InterruptedException {
        ...
        emailInput.clear();
        emailInput.sendKeys("singhjitujitendra34@gmail.com");
    }
    ...
    public void testPasswordInput() throws InterruptedException {
        ...
        passwordField.clear();
        passwordField.sendKeys("Pearl@2031");
        //Thread.sleep(2000); // Sleep for 2 seconds
    }
    ...
    public void testSignInButton() throws InterruptedException {
        // Click on "Sign in"
        WebElement signInButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Next']")));
    ...
    public void testSwitchBackToOriginalWindow() throws InterruptedException {
        ...
        WebElement signInButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Continue']"))); // Adjust this based on the next expected element after login
        signInButton.click();
        Thread.sleep(2000); // Sleep for 2 seconds
    ...
    public void testHomePageActions() throws InterruptedException {
        // Home page actions
        WebElement element = driver.findElement(By.xpath("//p[text()='Home']"));
    ...
    @Test(dependsOnMethods ="testinputElement3",alwaysRun = true)
    ...
    public void testClickExperimentsAgain() throws InterruptedException {
        WebElement experimentsElement = driver.findElement(By.xpath("//p[@class='text-sm font-medium' and text()='Experiments']"));
        Assert.assertTrue(experimentsElement.isDisplayed(), "Experiments element is not visible.");
        experimentsElement.click();
    }
