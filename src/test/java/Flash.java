...
public class Flash {
    ...
    public void testScreenView() throws InterruptedException {
        // Screen View
        WebElement siElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Screen View1_7sept']")));
    ...
    public void testClickPixelInsight() throws InterruptedException {
        ...
        WebElement pixelInsightElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//p[normalize-space()='Percept_insight']")));
        Assert.assertTrue(pixelInsightElement.isDisplayed(), "Pixel Insight element is not visible.");
        pixelInsightElement.click();
        Thread.sleep(10000);
    }
/*
    @Test(dependsOnMethods = "testClickPixelInsight")
    ...
    @Test(dependsOnMethods = "testClickArrowAndAllReports")
    ...
    @Test(dependsOnMethods = "testClickArrowElement")
    public void testClickFunnelStep() throws InterruptedException {
        // Click on "Funnel_10_step" element
        WebElement fsElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Funnel_10_step']")));
...
*/
    ...
    public void testClick10thStepFlow() throws InterruptedException {
        // Click on "7thstep flow" element
        WebElement flElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='flow_7step']")));
        Assert.assertTrue(flElement.isDisplayed(), "7thstep flow element is not visible.");
        flElement.click();
        Thread.sleep(10000);
    }
    ...
    public void testClickPixelDashboard() throws InterruptedException {
        WebElement pixelDashboardElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[contains(text(),'Flash_Board')]")));
    ...
    /*
    @Test(dependsOnMethods = "testClickTemplates")
    ...
    @Test(dependsOnMethods = "testClickExperiments")
    ...
    @Test(dependsOnMethods = "testClickExperiment")
    public void testClickExperimentsAgain() throws InterruptedException {
        WebElement experimentsElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[normalize-space()='Experiments']")));
        Assert.assertTrue(experimentsElement.isDisplayed(), "Experiments element is not visible.");
        experimentsElement.click();
    }
    @Test(dependsOnMethods = "testClickExperimentsAgain")
    ...
    @Test(dependsOnMethods = "testClickFeatureFlags")
    ...
    public void testClickSvgElement1() throws InterruptedException {
        WebElement liElement = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html[1]/body[1]/div[1]/main[1]/div[1]/div[1]/div[1]/div[2]/button[4]/div[1]/*[name()='svg']")));
